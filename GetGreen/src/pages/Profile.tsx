...
import { Bell, Camera, ChevronRight, Lock, Mail, Moon, Phone, User } from 'lucide-react-native'
import React from 'react'
import { Image, Platform, ScrollView, StyleSheet, TouchableOpacity, View } from 'react-native'
import { UserDto} from "@/src/pages/dto/UserDto";
    ...
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        <View style={styles.profileImageContainer}>
          <Image source={{ uri: mockUser.profilePic }} style={styles.profileImage} />
          <TouchableOpacity style={styles.editButton}>
            <Icon as ={Camera} color={theme.colors.text.primary} size='sm' />
          </TouchableOpacity>
        </View>
        <CustomText style={styles.name}>{mockUser.firstName} {mockUser.lastName}</CustomText>
      </View>
